...
const isFocus = ref(false) // 控制下拉框是否展示onFocusHandler
...
// 触发搜索
const onSearchHandlder = () => emits(EMIT_SEARCH, inputValue)
...
//失去焦点事件
const onBlurHandle = () => emits(EMIT_BLUR)

const containerTarget = ref(null)
onClickOutside(containerTarget, () => isFocus.value = false) // 点击区域外隐藏
